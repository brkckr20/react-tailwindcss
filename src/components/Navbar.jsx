    ...
    return (
        <div className='w-screen h-[80px] bg-zinc-200 fixed drop-shadow-lg z-50'>
            ...
            <div className="px-2 flex justify-between items-center w-full h-full">
                <div className='flex items-center'>
                    ...
                    <ul className='hidden md:flex'>
                        ...
                        <li><Link to="about" smooth={true} offset={-90} duration={500}>About</Link></li>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                ...
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="about" smooth={true} offset={-90} duration={500}>About</Link></li>
...
{/* 
                ...
                <div className='flex flex-col my-4'>
                    <button className='bg-transparent text-indigo-600 px-4 py-2 mb-4'> Sign In </button>
                    <button className="px-4 py-2"> Sign Up </button>
                </div>
            </ul>
