    ...
    return (
        <div className='w-full mt-24 bg-slate-900 text-gray-300 py-8 px-2'>
            <div className='max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8'>
                <div>
                    ...
                    <ul>
                        ...
                        <li className='py-1'>Analystic</li>
                ...
                <div className='col-span-2 pt-8 md:pt-2'>
                    ...
                    <form className='flex flex-col sm:flex-row'>
                        <input className='w-full pl-2 mr-4 rounded-md mb-4' type="email" placeholder='Enter email...'/>
            ...
            <div className='flex flex-col max-w-[1240px] px-2 py-4 mx-auto justify-between  sm:flex-row text-center text-gray-500 '>
                <p className='py-4'>2022 Wokflow, LLC. All right reserved</p>
